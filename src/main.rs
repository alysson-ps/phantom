...
use phantom_language_server::completion::completion;
use phantom_language_server::jump_definition::get_definition;
use phantom_language_server::reference::get_reference;
        ...
        let inlay_hint_list = hashmap
            ...
            .map(|(k, v)| {
                (
                    ...
                    k.end,
                    match v {
                        phantom_language_server::chumsky::Value::Null => "null".to_string(),
                        phantom_language_server::chumsky::Value::Bool(_) => "bool".to_string(),
                        phantom_language_server::chumsky::Value::Num(_) => "number".to_string(),
                        phantom_language_server::chumsky::Value::Str(_) => "string".to_string(),
                        phantom_language_server::chumsky::Value::List(_) => "[]".to_string(),
                        phantom_language_server::chumsky::Value::Func(_) => v.to_string(),
                    },
                )
            })
            .filter_map(|item| {
    ...
    async fn completion(&self, params: CompletionParams) -> Result<Option<CompletionResponse>> {
        ...
        let completions = || -> Option<Vec<CompletionItem>> {
            ...
            for (_, item) in completions {
                match item {
                    phantom_language_server::completion::ImCompleteCompletionItem::Variable(
                        var,
                    ) => {
                    ...
                    phantom_language_server::completion::ImCompleteCompletionItem::Function(
                        name,
                        args,
                    ) => {
                        ret.push(CompletionItem {
